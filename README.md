...
- 🖥️ [Jahia-CLI](https://github.com/Fgerthoffert/jahia-cli), a PoC built to demonstrate feasibility and potential ways forward for orchestrating the Jahia platform. Its principles were later integrated as Jahia [provisioning API](https://github.com/Jahia/jahia-private/tree/master/bundles/provisioning).
